import sparseUndefined from 'typeson-registry/dist/presets/sparse-undefined.js';
...
export const typesonRegistrySCAReverter =
  function typesonRegistrySCAReverter (obj) {
    if (Array.isArray(obj)) {
      ...
      obj.forEach((x) => typesonRegistrySCAReverter(x));
      return;
    }
